...
import { Pencil, Check, X, Loader2, KeyRound, LogOut } from "lucide-react";
            ...
            <div className="max-w-3xl mx-auto px-6 py-16">
                        ...
                        {!editing ? (
                            <>
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-red-400 transition-colors border border-slate-700 hover:border-red-400/40 rounded-lg px-3 py-1.5"
                                        >
                                            <LogOut size={14} />
                                            Log out
                                        </button>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 text-sm text-cyan-400 hover:underline mt-4"
                                >
                                    <KeyRound size={14} />
                                    Change password
                                </button>
                ...
                <div className="py-10">
                    ...
                    {loadingAttempts ? (
                        ...
                        <p className="text-slate-500 text-sm py-8 text-center">No problems here yet.</p>
                    ) : (
